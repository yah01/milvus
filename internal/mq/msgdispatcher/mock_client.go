...
func (_m *MockClient) Register(vchannel string, pos *internalpb.MsgPosition, subPos mqwrapper.SubscriptionInitialPosition) (<-chan *msgstream.MsgPack, error) {
	ret := _m.Called(vchannel, pos, subPos)

	var r0 <-chan *msgstream.MsgPack
	if rf, ok := ret.Get(0).(func(string, *internalpb.MsgPosition, mqwrapper.SubscriptionInitialPosition) <-chan *msgstream.MsgPack); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(string, *internalpb.MsgPosition, mqwrapper.SubscriptionInitialPosition) error); ok {
...
func (_c *MockClient_Register_Call) Run(run func(vchannel string, pos *internalpb.MsgPosition, subPos mqwrapper.SubscriptionInitialPosition)) *MockClient_Register_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(*internalpb.MsgPosition), args[2].(mqwrapper.SubscriptionInitialPosition))
	})
	return _c
}
