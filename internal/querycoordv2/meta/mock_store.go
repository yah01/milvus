...
func (_m *MockStore) RemoveHandoffEvent(segmentInfo *datapb.SegmentInfo) error {
...
func (_c *MockStore_RemoveHandoffEvent_Call) Run(run func(segmentInfo *datapb.SegmentInfo)) *MockStore_RemoveHandoffEvent_Call {
	_c.Call.Run(func(args mock.Arguments) {
